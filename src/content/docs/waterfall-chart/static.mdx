...
description: Bridges, deltas, and totals stacked as one composable EvilChart
image: /og/waterfall-chart.png
links:
  github: https://github.com/legions-developer/evilcharts/blob/main/src/registry/charts/waterfall-chart.tsx
...
<CodeTabs>
  ...
  <TabsPanel value="cli">
    <CliBlock commands={["@evilcharts/waterfall-chart"]} />
  </TabsPanel>
      ...
      <Step>
        ...
        <StepContent>
          <ComponentSource
            ...
            title="components/evilcharts/charts/waterfall-chart.tsx"
          />
        </StepContent>
      </Step>
       <Step>
...
<ApiHeading>EvilWaterfallChart</ApiHeading>
...
<ApiTable>
  ...
  <ApiRow name="barRadius" type="number" default="4">
    Corner rounding for waterfall rectangles.
  </ApiRow>
  <ApiRow name="backgroundVariant" type="BackgroundVariant">
    Drops `<ChartBackground />` underneath `<BarChart />` children ordering.
  </ApiRow>
  ...
  <ApiRow name="chartProps" type="ComponentProps<typeof BarChart>">
    Native Recharts props forwarded to `<BarChart />`; refer to <Link href="https://recharts.github.io/en-US/api/BarChart/" _blank>Recharts BarChart</Link>.
  </ApiRow>
</ApiTable>
...
<ApiTable>
  <ApiRow name="isClickable" type="boolean" default="false">
    Enables pointer toggling (`selectBar`).
  </ApiRow>
...
<ApiTable>
  ...
  <ApiRow name="…gridProps">
    Forwarded verbatim; see <Link href="https://recharts.github.io/en-US/api/CartesianGrid/" _blank>CartesianGrid</Link>.
  </ApiRow>
</ApiTable>
...
<ApiTable>
  ...
  <ApiRow name="…axisProps">
    Forwarded extras per <Link href="https://recharts.github.io/en-US/api/XAxis/" _blank>Recharts XAxis</Link>.
  </ApiRow>
</ApiTable>
...
<ApiTable>
  ...
  <ApiRow name="…axisProps">
    Additional props forwarded untouched; consult <Link href="https://recharts.github.io/en-US/api/YAxis/" _blank>Recharts YAxis</Link>.
  </ApiRow>
</ApiTable>
...
<ApiTable>
  ...
  <ApiRow name="isClickable" type="boolean" default="false">
    Legend entries toggle waterfall selection identical to clickable bars when `<Bars />` opts in.
  </ApiRow>
</ApiTable>
...
Backdrop helper surfaced for API parity across EvilCharts. Prefer `backgroundVariant` on `<EvilWaterfallChart />` rather than nesting `<Background />`; the resolver skips that child when assembling `<BarChart />` descendants.

<ApiTable>
  <ApiRow name="variant" type="BackgroundVariant" default='"dots"'>
    Mirrors the pattern applied when assigning `backgroundVariant` on `<EvilWaterfallChart />`.
  </ApiRow>
</ApiTable>
